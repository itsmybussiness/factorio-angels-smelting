...
--GOLD
    ...
    results=
    {
      {type="fluid", name="liquid-chlorauric-acid", amount=12},
    },
    order = "d",
    },
    {
    ...
    ingredients ={
      {type="item", name="processed-gold", amount=2},
      {type="fluid", name="liquid-chlorauric-acid", amount=6},
	},
    results=
    {
...
--SMELTING
    ...
    results=
    {
      {type="fluid", name="liquid-molten-gold", amount=12},
    },
...
--CASTING
	...
	enabled = "false",
    ingredients ={
      {type="fluid", name="liquid-molten-gold", amount=4},
	},
    results=
    {
